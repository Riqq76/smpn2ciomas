...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-10" data-animate>
                ...
                <div class="card shadow-lg border-0">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="row align-items-center g-4">
                            ...
                            <!-- FOTO -->
                            <div class="col-12 col-md-5 text-center" data-animate>
                                <img src="../../asset/gedung.jpeg" class="img-fluid rounded shadow"
                            ...
                            <div class="col-12 col-md-7" data-animate>
                                ...
                                <p class="fw-semibold text-dark">
                                    <strong>SMP Negeri 2 Ciomas</strong> merupakan sekolah menengah pertama negeri
                                    di Kabupaten Bogor yang berkomitmen menghadirkan pendidikan berkualitas,
                                    inklusif, dan berorientasi pada pengembangan karakter peserta didik.
                                </p>

                                <p class="text-dark">
                                    Sekolah ini tidak hanya berfokus pada pencapaian akademik, tetapi juga pada
                                    pembentukan sikap disiplin, tanggung jawab, kepedulian sosial, serta penguatan
                                    nilai <strong>Pancasila</strong> dalam kehidupan sehari-hari siswa.
                                </p>

                                <p class="text-dark mb-0">
                                    Dengan dukungan tenaga pendidik profesional serta penerapan sistem
                                    <strong>Smart School</strong>, SMP Negeri 2 Ciomas terus berinovasi dalam
                                    menciptakan lingkungan belajar yang aman, nyaman, transparan, dan berbasis
                                    teknologi informasi.
                                </p>
